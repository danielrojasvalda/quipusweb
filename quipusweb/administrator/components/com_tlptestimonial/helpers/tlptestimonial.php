...
/**
 * Tlptestimonial helper.
 */
class TlptestimonialHelper {
    ...
    public static function addSubmenu($vName = '') {
        JHtmlSidebar::addEntry(
			JText::_('COM_TLPTESTIMONIAL_TITLE_TESTIMONIALS'),
			'index.php?option=com_tlptestimonial&view=testimonials',
			$vName == 'testimonials'
		);
		JHtmlSidebar::addEntry(
			JText::_('COM_TLPTESTIMONIAL_TITLE_CATEGORIES'),
			'index.php?option=com_tlptestimonial&view=categories',
			$vName == 'categories'
		);
		JHtmlSidebar::addEntry(
			JText::_('COM_TLPTESTIMONIAL_TITLE_SETTINGS'),
			'index.php?option=com_tlptestimonial&view=settings',
			$vName == 'settings'
		);
	...
	public static function getFileURL() {
		$cparams = JComponentHelper::getParams ('com_tlptestimonial');
		$psettings = & TlptestimonialHelper::config();
