...
<?php endif;?>
		...
		<table class="table table-striped" id="testimonialList">
			<thead>
				...
				<th class='left'>
				<?php echo JHtml::_('grid.sort',  'COM_TLPTESTIMONIAL_CATEGORY_NAME', 'a.category_name', $listDirn, $listOrder); ?>
				</th>
			...
			<?php foreach ($this->items as $i => $item) :
				...
				<?php endif; ?>
				<?php if ($canEdit) : ?>
					<a href="<?php echo JRoute::_('index.php?option=com_tlptestimonial&task=category.edit&id='.(int) $item->id); ?>">
