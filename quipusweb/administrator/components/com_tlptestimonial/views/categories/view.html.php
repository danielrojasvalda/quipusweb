 ...
 */
class TlptestimonialViewCategories extends JViewLegacy {
    ...
    public function display($tpl = null) {
        ...
        TlptestimonialHelper::addSubmenu('categories');
    ...
    protected function addToolbar() {
        ...
        $canDo = TlptestimonialHelper::getActions($state->get('filter.category_id'));

        JToolBarHelper::title(JText::_('COM_TLPTESTIMONIAL_TITLE_CATEGORIES'), 'categories.png');
        ...
        JHtmlSidebar::setAction('index.php?option=com_tlptestimonial&view=categories');
	...
	protected function getSortFields()
	{
		...
		'a.category_name' => JText::_('COM_TLPTESTIMONIAL_TESTIMONIALS_NAME'),
