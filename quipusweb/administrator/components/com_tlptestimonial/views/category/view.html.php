 ...
 * View to edit
 */
class TlptestimonialViewCategory extends JViewLegacy {
    ...
    protected function addToolbar() {
        ...
        $canDo = TlptestimonialHelper::getActions();

        JToolBarHelper::title(JText::_('COM_TLPTESTIMONIAL_TITLE_CATEGORY'), 'category.png');
