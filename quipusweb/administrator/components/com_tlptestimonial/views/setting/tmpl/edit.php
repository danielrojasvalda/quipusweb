...
<form action="<?php echo JRoute::_('index.php?option=com_tlptestimonial&layout=edit&id=' . (int) $this->item->id); ?>" method="post" enctype="multipart/form-data" name="adminForm" id="setting-form" class="form-validate">

    <div class="form-horizontal">
        <?php echo JHtml::_('bootstrap.startTabSet', 'myTab', array('active' => 'general')); ?>

        <?php echo JHtml::_('bootstrap.addTab', 'myTab', 'general', JText::_('COM_TLPTESTIMONIAL_TITLE_SETTINGS', true)); ?>
        <div class="row-fluid">
            ...
            <div class="control-group">
				<div class="control-label"><?php echo $this->form->getLabel('enable_read_more'); ?></div>
				<div class="controls"><?php echo $this->form->getInput('enable_read_more'); ?></div>
			</div>
            <div class="control-group">
				<div class="control-label"><?php echo $this->form->getLabel('character_limit'); ?></div>
				<div class="controls"><?php echo $this->form->getInput('character_limit'); ?></div>
			</div>
            <div class="control-group">
