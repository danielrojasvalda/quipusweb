...
class VirtueMartControllerCart extends JControllerLegacy {
	...
	public function display($cachable = false, $urlparams = false){
		...
		//http://stackoverflow.com/questions/32785533/virtuemart-3-0-10-disable-double-confirmation-on-checkout
			$cart->checkoutData(false);//added 30.05.2016 - this sets the $this->_dataValidated to the cart hash
			$cart->confirmDone(); //calls confirmDone
