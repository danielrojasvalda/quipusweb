...
var $anchor=$('a[data-id="'+id+'"]');if($anchor.length==0){return;}
if($anchor.closest('.nn_sliders').length==0){return;}
var $slider=$anchor.closest('.nn_sliders-group').find('.nn_sliders-body').first();if($slider.find('.nn_tabs').length>0){return;}
