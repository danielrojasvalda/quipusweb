...
class JFormFieldUpgradecheck extends JFormField {
	...
	protected function getLabel()
	{
		...
		//If cURL is supported, check the current version available.
				...
				$version = 1.2;
				$target = 'http://www.pixelpointcreative.com/upgradecheck/zoomin/index.txt';
				$curl = curl_init();
				...
				if ($version < $str)
					...
					<a href="index.php?option=com_installer&view=update">Update</a> &nbsp;&nbsp;|&nbsp; &nbsp;<a href="http://www.pixelpointcreative.com/support.html" target="_blank">Get Help</a> &nbsp;&nbsp;|&nbsp;&nbsp;<a href="http://www.pixelpointcreative.com/changelogs/zoomin.txt" target="_blank">View the Changelog</a></label></div>';
				...
				echo'<div style="float:left;clear: both;"><img width="180" height="80" border="0" src="../plugins/content/plg_zoomin/plg_zoomin/elements/zoom_logo.png" title="Zoom In" alt="Zoom In"></div>';  
				return 
				$message;
