...
<tr valign="top" class="sectiontableentry<?php echo $i ?>">
	...
	<td align="center" class="cartProductPrice" data-title="Price">
		<?php
	...
	<td align="right" class="cartProductQty" data-title="Quantity"><?php
	...
	<?php if (VmConfig::get ('show_tax')) { ?>
	<td align="right" class="cartProductTax" data-title="Tax"><?php echo "<span class='priceColor2'>" . $this->currencyDisplay->createPriceDiv ('taxAmount', '', $prow->prices, FALSE, FALSE, $prow->quantity) . "</span>" ?></td>
	<?php } ?>
	<td align="right" class="cartProductDiscount" data-title="Discount"><?php echo "<span class='priceColor2'>" . $this->currencyDisplay->createPriceDiv ('discountAmount', '', $prow->prices, FALSE, FALSE, $prow->quantity) . "</span>" ?></td>
...
<tr class="sectiontableentry1">
	...
	<?php if (VmConfig::get ('show_tax')) { ?>
	<td align="right" class="cartProductTax" data-title="Tax" ><?php echo "<span  class='priceColor2'>" . $this->currencyDisplay->createPriceDiv ('taxAmount', '', $this->cart->cartPrices, FALSE) . "</span>" ?></td>
	<?php } ?>
	<td align="right" class="cartProductDiscount" data-title="Discount"><?php echo "<span  class='priceColor2'>" . $this->currencyDisplay->createPriceDiv ('discountAmount', '', $this->cart->cartPrices, FALSE) . "</span>" ?></td>
	<td align="right" class="cartProductTotal" data-title="Total"><?php echo $this->currencyDisplay->createPriceDiv ('salesPrice', '', $this->cart->cartPrices, FALSE) ?></td>
</tr>
...
<tr class="sectiontableentry<?php echo $i ?>">
	...
	<td align="right" class="cartProductTotal" data-title="Total"><?php echo $this->currencyDisplay->createPriceDiv ($rule['virtuemart_calc_id'] . 'Diff', '', $this->cart->cartPrices[$rule['virtuemart_calc_id'] . 'Diff'], FALSE); ?> </td>
</tr>
	<?php
	if ($i) {
		$i = 1;
...
<tr class="sectiontableentry1" valign="top">
	...
	<?php if (VmConfig::get ('show_tax')) { ?>
	<td align="right" class="cartProductTax" data-title="Tax"><?php echo "<span  class='priceColor2'>" . $this->currencyDisplay->createPriceDiv ('shipmentTax', '', $this->cart->cartPrices['shipmentTax'], FALSE) . "</span>"; ?> </td>
	<?php } ?>
	...
	<td align="right" class="cartProductTotal" data-title="Total"><?php echo $this->currencyDisplay->createPriceDiv ('salesPriceShipment', '', $this->cart->cartPrices['salesPriceShipment'], FALSE); ?> </td>
</tr>
<?php } ?>
...
<tr class="sectiontableentry1"  valign="top">
	...
	<?php } ?>
	<?php if (VmConfig::get ('show_tax')) { ?>
	<td align="right" class="cartProductTax" data-title="Tax"><?php echo "<span  class='priceColor2'>" . $this->currencyDisplay->createPriceDiv ('paymentTax', '', $this->cart->cartPrices['paymentTax'], FALSE) . "</span>"; ?> </td>
	<?php } ?>
	...
	<td align="right" class="cartProductTotal" data-title="Total"><?php  echo $this->currencyDisplay->createPriceDiv ('salesPricePayment', '', $this->cart->cartPrices['salesPricePayment'], FALSE); ?> </td>
</tr>
<?php  } ?>
<tr>
	<td colspan="4">&nbsp;</td>
...
<tr class="sectiontableentry2">
	...
	<?php if (VmConfig::get ('show_tax')) { ?>
	<td align="right" class="cartProductTax" data-title="Tax"> <?php echo "<span  class='priceColor2'>" . $this->currencyDisplay->createPriceDiv ('billTaxAmount', '', $this->cart->cartPrices['billTaxAmount'], FALSE) . "</span>" ?> </td>
	<?php } ?>
	<td align="right" class="cartProductDiscount" data-title="Discount"> <?php echo "<span  class='priceColor2'>" . $this->currencyDisplay->createPriceDiv ('billDiscountAmount', '', $this->cart->cartPrices['billDiscountAmount'], FALSE) . "</span>" ?> </td>
	<td align="right" class="cartProductTotal" data-title="Total"><strong><?php echo $this->currencyDisplay->createPriceDiv ('billTotal', '', $this->cart->cartPrices['billTotal'], FALSE); ?></strong></td>
</tr>
<?php
