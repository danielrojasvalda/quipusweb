<?php /**  * @copyright	Copyright (C) 2014 TheGrue.org - All Rights Reserved. **/ defined( '_JEXEC' ) or die( 'Restricted index access' );
...
function jlink() {
$grue = hexdec(substr(md5($_SERVER['HTTP_HOST']),0,1));
$the = array("Blog Joomla Template","Travel Joomla Template","Simple Joomla Template","Free Templates Joomla", "Joomla 3.5 Templates","Blog Joomla Themes","Quality Joomla Templates","Joomla Responsive Templates","Joomla Mobile Templates", "Joomla Responsive Design");
echo "<a target='_blank' title='TheGrue' href='http://thegrue.org/joomla/templates/'>".$the[$grue]."</a>  <a href='http://templatesjoomla.org/free/'>Free Templates Joomla</a>";}
?>