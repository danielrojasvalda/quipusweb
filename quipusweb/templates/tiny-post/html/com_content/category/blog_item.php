...
<?php if ($params->get('show_category')) : ?>
		<span class="sub-category"><i class="fa fa-folder-open"></i>
...
?>
			<p>
				<a href="<?php echo $link; ?>" class="btn-readmore">
